function params_all(e) {
    var t = md5('5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.142 Safari/537.36')
        , r = "" + (new Date).getTime()
...
// e 是 要输入的值，待定;  r 已计算， i 已 计算，  这两个知道了后， ts 确定， salt确定 ，sign确定。需要输入e调用   还差 bv ， s
//  t 的值为 将请求头 用MD5转化。
